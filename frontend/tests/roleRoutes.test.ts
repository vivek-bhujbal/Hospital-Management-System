...
test('Super Admin is redirected away from hospital Admin routes', () => {
  ...
  assert.equal(protectedPortalRedirect('/admin/pharmacy', 'admin'), null)
  assert.equal(protectedPortalRedirect('/admin/pharmacy/medicines', 'admin'), null)
  assert.equal(protectedPortalRedirect('/admin/pharmacy/categories', 'admin'), null)
  assert.equal(protectedPortalRedirect('/admin/pharmacy/suppliers', 'admin'), null)
  assert.equal(protectedPortalRedirect('/admin/pharmacy/unknown', 'admin'), '/admin/home')
